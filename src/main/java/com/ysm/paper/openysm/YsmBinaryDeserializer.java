...
public class YsmBinaryDeserializer implements AutoCloseable{
    ...
    public void parseYSMFooter(RawYsmModel footer) {
        try {
            ...
            // Some legacy archives omit the export footer. Keep default footer values.
        }
    }
    ...
    private void deserializeLegacyV1() {
        ...
        for (int i = 0; i < animationBlobCount; ++i) {
            ...
            model.mainEntity.animationFiles.put(animKeyFromType(animationId), rawAnimationFile);
    ...
    private static String animKeyFromType(int type) {
        return switch (type) {
            case 1 -> "main";
            case 2 -> "arm";
            case 3 -> "extra";
    ...
    public YsmBinaryBuffer getReader() {
        return reader;
    }
}
